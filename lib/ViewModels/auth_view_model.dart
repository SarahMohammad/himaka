...
class AuthViewModel extends BaseModel {
  ...
  Future<LoginResponse> register(
    ...
    LoginUserResponse user = new LoginUserResponse(
        ...
        question: ques,
        answer: answer,
        withdraw_way_id: withdrawId,
        withdraw_field_value: withdrawValue,
        withdraw_field_description: withdrawDesc);
  ...
  bool signUpValidation(String fName, String lName, String email, String phone,
      String password, String cPass, String code) {
    bool validate = true;
    if (!RegExp(
            r"^[a-zA-Z0-9.a-zA-Z0-9.!#$%&'*+-/=?^_`{|}~]+@[a-zA-Z0-9]+\.[a-zA-Z]+")
        .hasMatch(email)) {
